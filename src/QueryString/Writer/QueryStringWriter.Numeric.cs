...
public partial class QueryStringWriter
{
    ...
    {
        Add(null, value.ToString("F0", CultureInfo.InvariantCulture));
    }
    ...
    {
        Add(null, value.ToString($"F{precision ?? _options.DefaultPrecision}", CultureInfo.InvariantCulture));
    }
    ...
    {
        Add(key, value.ToString("F0", CultureInfo.InvariantCulture));
    }
    ...
    {
        Add(key, value.ToString($"F{precision ?? _options.DefaultPrecision}", CultureInfo.InvariantCulture));
    }
